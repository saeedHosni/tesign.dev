...
function FooterLinkCol({ title, links }) {
  return (
    <div>
      <h4 className="text-[0.85rem] font-black text-text-primary mb-[18px] tracking-[0.04em]">
        {title}
      </h4>
    ...
    <footer id="about" className="bg-bg-surface border-t border-border-default pt-[72px] pb-10">
      <div className="w-full max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-8 md:gap-10 lg:gap-12 mb-14">
          ...
          <div>
            ...
            <p className="text-[0.85rem] text-text-muted leading-[1.8] max-w-[260px]">
              تیمی از متخصصان طراحی و توسعه که با اشتیاق برای ساخت تجربه‌های دیجیتال ماندگار تلاش می‌کنند. از طراحی تا راه‌اندازی، همه‌جا کنار شما هستیم.
            </p>
            <div className="flex gap-2.5 mt-5">
              <SocialBtn href="#" label="اینستاگرام">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
              </SocialBtn>
              <SocialBtn href="#" label="تلگرام">
              ...
              <SocialBtn href="#" label="یوتیوب">
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.4a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75,15.02 15.5,12 9.75,8.98 9.75,15.02"/></svg>
              </SocialBtn>
            </div>
          </div>
        ...
        <div className="border-t border-border-default pt-7 flex flex-col lg:flex-row items-center justify-between gap-4 text-center lg:text-start">
          <div className="text-[0.78rem] text-text-muted">© ۱۴۰۴ دیجی‌تیم · تمامی حقوق محفوظ است.</div>
          <div className="flex gap-5">
            {['حریم خصوصی', 'شرایط استفاده', 'نقشه سایت'].map(item => (
              <a key={item} href="#" className="text-[0.78rem] text-text-muted no-underline transition-colors duration-300 hover:text-accent-yellow">
                {item}
              </a>
            ))}
          </div>
